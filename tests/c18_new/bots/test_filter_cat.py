"""
Tests for src/core/c18/bots/filter_cat.py
...
from src.core.c18.bots.filter_cat import (
    Skippe_Cat,
    filter_cats_text,
...
class TestFilterCatsText:
    ...
    def test_removes_template_categories_from_articles(self, mocker):
        ...
        mocker.patch("src.core.c18.bots.filter_cat.templatequerymulti", return_value={})
        mocker.patch("src.core.c18.bots.filter_cat.templatequery", return_value=False)
        mocker.patch("src.core.c18.bots.filter_cat.get_deleted_pages", return_value=[])
    ...
    def test_removes_deleted_pages(self, mocker):
        ...
        mocker.patch("src.core.c18.bots.filter_cat.templatequerymulti", return_value={})
        mocker.patch("src.core.c18.bots.filter_cat.templatequery", return_value=False)
        mocker.patch("src.core.c18.bots.filter_cat.get_deleted_pages", return_value=["تصنيف:محذوف"])
    ...
    def test_removes_categories_with_redirect_template(self, mocker):
        ...
        mocker.patch(
            "src.core.c18.bots.filter_cat.templatequerymulti",
            return_value={"تصنيف:علوم": {"templates": ["قالب:تحويل تصنيف"]}},
        )
        mocker.patch("src.core.c18.bots.filter_cat.templatequery", return_value=["قالب:تحويل تصنيف"])
        mocker.patch("src.core.c18.bots.filter_cat.get_deleted_pages", return_value=[])
