...
from src.core.newapi.api_client.exceptions import MaxlagError
from src.core.newapi.api_client.requests_handler import RequestsHandler
...
class TestMaxlagHandling:
    ...
    def test_maxlag_error_retries_and_succeeds(self):
        ...
        with patch("src.core.newapi.api_client.requests_handler.time.sleep") as mock_sleep:
            result = client.client_request_retry({"action": "query"}, method="get")
    ...
    def test_maxlag_exhausted_retries_raises_maxlag_error(self):
        ...
        with patch("src.core.newapi.api_client.requests_handler.time.sleep"):
...
class TestHandleMaxlag:
    ...
    def test_handle_maxlag_with_invalid_retry_after_uses_backoff(self):
        ...
        with patch("src.core.newapi.api_client.requests_handler.time.sleep") as mock_sleep:
            with patch("src.core.newapi.api_client.client.settings") as mock_settings:
