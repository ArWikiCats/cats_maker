...
from src.core.newapi.api_client.exceptions import LoginError, WikiClientError
...
class TestEnrichParams:
    ...
    @patch("src.core.newapi.api_client.client.mwclient.Site")
    @patch("src.core.newapi.api_client.cookies_client.get_cookie_path")
