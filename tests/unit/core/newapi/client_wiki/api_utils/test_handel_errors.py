...
from src.core.newapi.client_wiki.api_utils.handel_errors import HandleErrors
...
class TestHandleErrors:
    ...
    def test_logs_error_when_do_error_true(self, mocker):
        ...
        handler = HandleErrors()
        mock_logger = mocker.patch("src.core.newapi.client_wiki.api_utils.handel_errors.logger")
    ...
    def test_clears_data_and_text_when_params_provided(self, mocker):
        ...
        handler = HandleErrors()
        mocker.patch("src.core.newapi.client_wiki.api_utils.handel_errors.logger")
