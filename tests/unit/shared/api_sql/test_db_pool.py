...
from src.shared.api_sql.db_pool import DatabaseManager
from src.shared.api_sql.exceptions import (
...
class TestDatabaseManagerGetConnection:
    ...
    def test_raises_when_not_production(self, mocker):
        mocker.patch(
            "src.shared.api_sql.config.ConfigLoader.is_production",
            return_value=False,
        )
        dm = DatabaseManager()
    ...
    def test_opens_and_closes_connection(self, mocker):
        ...
        mocker.patch(
            "src.shared.api_sql.config.ConfigLoader.get_db_config",
