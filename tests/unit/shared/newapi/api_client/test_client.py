...
from src.shared.newapi.api_client.exceptions import LoginError, WikiClientError
...
def _make_client(lang="en", family="wikipedia", username="MyBot", password="pass", cookies_dir=None):
    ...
    with (
        ...
        kw = {"lang": lang, "family": family, "username": username, "password": password}
...
class TestEnrichParams:
    ...
    @patch("src.shared.newapi.api_client.client.mwclient.Site")
    @patch("src.shared.newapi.api_client.cookies_client.get_cookie_path")
