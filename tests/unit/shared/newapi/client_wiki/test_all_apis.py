...
from src.shared.newapi.client_wiki.all_apis import AllAPIS
...
class TestALLAPIS:
    @patch("src.shared.newapi.client_wiki.all_apis.WikiLoginClient")
    ...
    @patch("src.shared.newapi.client_wiki.all_apis.super_page")
    @patch("src.shared.newapi.client_wiki.all_apis.WikiLoginClient")
    ...
    @patch("src.shared.newapi.client_wiki.all_apis.catdepth_new")
    @patch("src.shared.newapi.client_wiki.all_apis.WikiLoginClient")
