...
def disable_network(mocker):
    ...
    mocker.patch(
        "src.core.newapi.api_client.client.mwclient.client.requests.get", side_effect=Exception("Network disabled in tests")
    )
    mocker.patch(
        "src.core.newapi.api_client.client.mwclient.client.requests.post", side_effect=Exception("Network disabled in tests")
    )
