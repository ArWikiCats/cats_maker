"""
Tests for src/core/c18/cat_tools_enlist2.py
...
from src.core.c18.cat_tools_enlist2 import (
    MakeLitApiWay,
)
...
class TestMakeLitApiWay:
    ...
    def test_calls_categorized_page_generator(self, mocker):
        ...
        mock_cpg = mocker.patch("src.core.c18.cat_tools_enlist2.Categorized_Page_Generator", return_value=[])
        mocker.patch("src.core.c18.cat_tools_enlist2.get_arpage_inside_encat", return_value=[])
    ...
    def test_includes_pages_from_encat(self, mocker):
        ...
        mocker.patch("src.core.c18.cat_tools_enlist2.Categorized_Page_Generator", return_value=["Page1"])
        mocker.patch("src.core.c18.cat_tools_enlist2.get_arpage_inside_encat", return_value=["صفحة_عربية"])
        mocker.patch(
            "src.core.c18.cat_tools_enlist2.find_LCN",
    ...
    def test_returns_false_for_no_pages(self, mocker):
        ...
        mocker.patch("src.core.c18.cat_tools_enlist2.Categorized_Page_Generator", return_value=[])
        mocker.patch("src.core.c18.cat_tools_enlist2.get_arpage_inside_encat", return_value=[])
